...
/* Status: type-only support for retained, non-baseline SST-dependent source. */
/* It is not a Repa deployment config; current authority is indexed by docs/README.md. */
/* tslint:disable */
/* eslint-disable */
