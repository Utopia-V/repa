...
export const Definitions = {
  ...
  session_start_location: keybind("none", "Choose the next session directory"),
  ...
  "dialog.session_start_location.new": keybind("ctrl+m", "New project copy"),
  "dialog.session_start_location.delete": keybind("ctrl+d", "Delete project copy"),
  "dialog.session_start_location.refresh": keybind("ctrl+r", "Refresh project copies"),
...
export const CommandMap = {
  ...
  status_view: "repa.status",
  debug_view: "repa.debug",
  session_export: "session.export",
  session_copy: "session.copy",
  session_start_location: "session.start_location",
