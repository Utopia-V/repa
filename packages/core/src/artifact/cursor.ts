export * as ArtifactCursor from "./cursor"
...
export const Endpoint = Schema.Union([
  ...
  Schema.Literal("bindings"),
  Schema.Literal("observations"),
  Schema.Literal("observation_corrections"),
  Schema.Literal("lineage_corrections"),
])
