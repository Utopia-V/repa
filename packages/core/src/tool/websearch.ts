...
export const defaultConfigLayer = Layer.sync(ConfigService, () =>
  ConfigService.of({
    provider:
      process.env.REPA_WEBSEARCH_PROVIDER === "exa" || process.env.REPA_WEBSEARCH_PROVIDER === "parallel"
        ? process.env.REPA_WEBSEARCH_PROVIDER
        : undefined,
    enableExa: truthy("REPA_EXPERIMENTAL") || truthy("REPA_ENABLE_EXA") || truthy("REPA_EXPERIMENTAL_EXA"),
    enableParallel: truthy("REPA_ENABLE_PARALLEL") || truthy("REPA_EXPERIMENTAL_PARALLEL"),
              ...
              const text =
                provider === "exa"
                  ...
                  : yield* callMcp(
                      ...
                      {
                        "User-Agent": `repa/${InstallationVersion}`,
