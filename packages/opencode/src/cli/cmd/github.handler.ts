/**
 * Hibernated inherited GitHub Action implementation.
 * It is intentionally absent from the root CLI and current release surface.
 * Activation requires a separate Repa product decision.
 */
