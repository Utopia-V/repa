...
const withHome = <A, E, R>(home: string, self: Effect.Effect<A, E, R>) =>
  Effect.acquireUseRelease(
    Effect.sync(() => {
      const prev = process.env.REPA_TEST_HOME
    ...
    (prev) =>
      Effect.sync(() => {
        process.env.REPA_TEST_HOME = prev
      }),
  )
      ...
      (dir) =>
        withHome(
          ...
          Effect.gen(function* () {
            yield* Effect.promise(() =>
              Bun.write(
                path.join(dir, ".repa", "skill", "dir-skill", "SKILL.md"),
                `---
name: dir-skill
...
`,
            ...
            expect(dirs).toContain(path.join(dir, ".repa", "skill", "dir-skill"))
      ...
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Promise.all([
              Bun.write(
                path.join(dir, ".repa", "skill", "skill-one", "SKILL.md"),
                `---
name: skill-one
...
`,
              ...
              Bun.write(
                path.join(dir, ".repa", "skill", "skill-two", "SKILL.md"),
                `---
name: skill-two
...
`,
              ...
              Bun.write(
                path.join(dir, ".repa", "skill", "opencode-skill", "SKILL.md"),
                `---
name: opencode-skill
description: A skill in the .repa/skill directory.
---
...
`,
              ...
              Bun.write(
                path.join(dir, ".repa", "skill", "agent-skill", "SKILL.md"),
                `---
name: opencode-skill
description: A skill in the .repa/skill directory.
---
...
`,
              ...
              Bun.write(
                path.join(dir, ".repa", "skills", "agent-skill", "SKILL.md"),
                `---
name: opencode-skill
description: A skill in the .repa/skills directory.
---
