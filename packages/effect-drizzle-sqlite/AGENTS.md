...
- Do not add Repa-specific tables, paths, migrations, post-commit hooks, or domain storage APIs here.
...
- If touching Effect APIs, inspect the installed dependency source and nearby
  repository usage. Do not assume a maintainer-specific external checkout path
  or clone reference source into this repository.
