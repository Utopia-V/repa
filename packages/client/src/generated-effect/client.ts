...
type Endpoint3_2Request = Parameters<RawClient["server.session"]["session.get"]>[0]
...
type Endpoint3_3Request = Parameters<RawClient["server.session"]["session.switchAgent"]>[0]
type Endpoint3_3Input = {
  readonly sessionID: Endpoint3_3Request["params"]["sessionID"]
  readonly agent: Endpoint3_3Request["payload"]["agent"]
}
...
type Endpoint3_4Request = Parameters<RawClient["server.session"]["session.switchModel"]>[0]
type Endpoint3_4Input = {
  readonly sessionID: Endpoint3_4Request["params"]["sessionID"]
  readonly model: Endpoint3_4Request["payload"]["model"]
}
...
type Endpoint3_5Request = Parameters<RawClient["server.session"]["session.revert.stage"]>[0]
type Endpoint3_5Input = {
  ...
  readonly files?: Endpoint3_5Request["payload"]["files"]
}
...
type Endpoint3_6Request = Parameters<RawClient["server.session"]["session.revert.clear"]>[0]
...
type Endpoint3_7Request = Parameters<RawClient["server.session"]["session.revert.commit"]>[0]
...
type Endpoint3_8Request = Parameters<RawClient["server.session"]["session.context"]>[0]
...
type Endpoint3_9Request = Parameters<RawClient["server.session"]["session.history"]>[0]
type Endpoint3_9Input = {
  readonly sessionID: Endpoint3_9Request["params"]["sessionID"]
  readonly limit?: Endpoint3_9Request["query"]["limit"]
  readonly after?: Endpoint3_9Request["query"]["after"]
}
...
type Endpoint3_10Request = Parameters<RawClient["server.session"]["session.events"]>[0]
type Endpoint3_10Input = {
  readonly sessionID: Endpoint3_10Request["params"]["sessionID"]
  readonly after?: Endpoint3_10Request["query"]["after"]
}
...
type Endpoint3_11Request = Parameters<RawClient["server.session"]["session.message"]>[0]
type Endpoint3_11Input = {
  readonly sessionID: Endpoint3_11Request["params"]["sessionID"]
  readonly messageID: Endpoint3_11Request["params"]["messageID"]
}
...
const adaptGroup3 = (raw: RawClient["server.session"]) => ({
  ...
  get: Endpoint3_2(raw),
  switchAgent: Endpoint3_3(raw),
  switchModel: Endpoint3_4(raw),
  stage: Endpoint3_5(raw),
  clear: Endpoint3_6(raw),
  commit: Endpoint3_7(raw),
  context: Endpoint3_8(raw),
  history: Endpoint3_9(raw),
  events: Endpoint3_10(raw),
  message: Endpoint3_11(raw),
})
