...
if (values.help) {
  console.log(`
Usage: bun .github/hibernated-workflows/support/github/close-prs.ts [options]
...
Examples:
  REPA_RUN_HIBERNATED_OPENCODE_AUTOMATION=1 bun .github/hibernated-workflows/support/github/close-prs.ts
  REPA_RUN_HIBERNATED_OPENCODE_AUTOMATION=1 bun .github/hibernated-workflows/support/github/close-prs.ts --threshold 2 --print-limit 100
  REPA_RUN_HIBERNATED_OPENCODE_AUTOMATION=1 bun .github/hibernated-workflows/support/github/close-prs.ts --execute --threshold 2 --max-close 25
`)
  process.exit(0)
}
