...
No lab is active. ALS-022B/C reject a universal DeepSeek-V4-Flash selector;
...
and reviewable first-production contract. No lab is active and no further live
model work is admitted in this phase. The next gate is contract admission and a
coherent production slice, not another selector, prompt rescue, or provider
campaign. A general constraint vocabulary and multi-candidate policy remain
explicitly unproved.
