...
| Current production fork                                                                                                                      | Independently accepted implementation/evidence snapshot fixed by commit `5e762f8336b33d7d8365c9bc9204b52f52eba114` | TypeScript/Bun modular monolith, native database, Effect services, closed domain APIs                                                           | New dedicated authority rather than inherited OpenCode or pre-fork schema                                                                                  |
...
layer; maintainer-authorized commit `5e762f833` fixes that snapshot and formally
closes the Gate.
