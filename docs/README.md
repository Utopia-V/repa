...
Status: Gates 0–10 are closed. Gate 10 content-root authority and bounded
observation passed at implementation commit `fb6ed5763` after the original
whole-Gate independent reviewer accepted both its contract/theory and
