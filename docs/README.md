...
production/test candidate is committed on branch
`codex/gate-20-future-attention` at `1f92169840559b63eb8f96c31a67985c814a86f0`.
It is not merged into `main`; no release or Gate 21+ transition exists.
...
accepted; exact feature-branch implementation commit `1f9216984` awaits mainline
merge. Release and Gate 21+ remain separately governed.
