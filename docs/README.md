...
whole-Gate review run
  ...
  ordering. Rejected recovery `final-11` is preserved; ordinal-correct recovery
  `final-12` now awaits the same reviewer. Contract acceptance remains intact;
  implementation/evidence acceptance, integration, release, and Gate 22/23
  remain pending.
...
layers are both accepted. Fresh separate top-level reviewer task
...
| 5. [Inherited product-surface disposition](research/opencode-fork-gate-05-terminal-only-surface-disposition-2026-07-14.md) | Disconnects excluded inherited product behavior while retaining independently useful local capabilities and harmless hibernated source.                                                       | **Retained OAuth regression corrected at `16b5589c1`.** Reviewer `019fb7fb-c516-7ee0-9741-7760b0cd548d` accepted the exact ten-path restoration of the released-v1 `CodexAuthPlugin` and Core browser/headless registrations. ChatGPT Plus/Pro login works without an API key and writes only Repa's existing credential store; 44 focused tests / 68 assertions and the real four-Turn released-model path pass. Corrective integration `9e91d43c6` remains accepted for the other terminal-only, identity, preview-v2, and restricted-Agent boundaries; `86332c246` remains historical provenance. Explicitly enabled dormant upstream release material still blocks a later release-readiness claim.                                                                                                                                                                                                                                            |
...
| 8. [Learning-command settlement](research/opencode-fork-gate-08-learning-command-settlement-2026-07-16.md)                 | Binds trusted occurrence and physical invocation identity to one real Course-owned semantic effect.                                                                                           | **`G8-IMM-001` correction integrated at `19d0fe933`.** Original reviewer `019f68d9-5853-7e23-8592-dc41b90ac9bb` accepted the exact V15 per-message diff projection. It commits outside immutable User `data`, reads before legacy/fallback recomputation, backfills historical arrays, and survives Snapshot cleanup and fork/source deletion. Core migration 40/355, Session 34/237, Prompt 14/111, Processor 30/158, and the real U1/U2 regression 3/22 pass. Corrective integration `9e91d43c6` and original Course proof `293ff6892` remain retained.                                                                                                                                                                                                                                                                                                                                                                                          |
...
| 12. [Durable Turn lifecycle](research/opencode-fork-gate-12-durable-turn-lifecycle-2026-07-18.md)                          | Makes one admitted root request begin a finite durable Turn that may later admit exact-target steers, with exact model/tool membership, budgets, child lineage, terminal truth, and recovery. | **Scoped owner-handoff correction integrated at `29f5a140f`.** The strict start/steer, exact-target race, lifecycle, recovery, and primary-TUI correction at `80f5fa30a` / `c5ea10b8a` remain accepted. Original reviewer `019fad21-8a6a-7450-af90-505c0bce53f8` closed `G12-OH-001-R1` and `G12-OH-002` against the exact eight-path binding. Promotion-ready idle is exact-owner guarded and revision ordered, a distinct B can start directly without queue/retry/retarget, and non-fatal prune failure is logged. Session 33/234, Prompt 14/111, and Processor 30/158 pass. No Gate 8/14/16/17 boundary was absorbed by this integration.                                                                                                                                                                                                                                                                                                      |
...
| 21A. [Tutor move selection and flow continuity](research/repa-gate-21a-tutor-move-selection-flow-continuity-2026-08-12.md) | Accepted contract for the ordinary `repa` Agent to compose one exact request, bounded current learning Context, retained steering, and owner-native reads into a useful current move or one necessary learner-visible clarification, then choose again from current truth after correction or failure. | **Contract/theory accepted; [implementation/evidence candidate](research/repa-gate-21a-tutor-move-selection-flow-continuity-implementation-evidence-2026-08-12.md) awaits closure of `G21A-IR-008` and is not integrated.** Review run `repa-g21a-contract-1f881e-20260812`, retained reviewer `019ff1c6-97c5-7441-bb96-77d863f3a4d5`, accepted exact semantic SHA-256 `307F9D4F...BA0787F` after closing `G21A-CR-001..003`; implementation closure has closed `IR-001..004`, `006`, and reviewer-mutation recovery `IR-007`, while the original `IR-005` runner repair remains valid. Ordinal-correct recovery root `final-12` is the current closure target for mechanical seal finding `IR-008`. The candidate adds no selector, scheduler, activity owner, hard-limit increase, Gate 22 UI, or Gate 23 integration claim. |
