...
- **Gate 21A — Tutor move selection and flow continuity:** the representative
  ...
  steering, Goal, future attention, planning, recent Interaction, time, any
...
- **Gate 23 — integrated product loop:** one smallest connected causal trace
  ...
  future-attention, planning, steering, recent-Interaction, and any
...
21A without renumbering Gates 22 or 23. No Gate below authorizes implementation
until its own pre-implementation grill closes and any required contract review
is accepted.
