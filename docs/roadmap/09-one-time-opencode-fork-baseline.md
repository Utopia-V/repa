...
| 3. Repa identity isolation | Change only binary/product identity and application-owned paths so a fresh Repa launch cannot read or write OpenCode state. [Contract recorded 2026-07-13.](../research/opencode-fork-gate-03-repa-identity-isolation-2026-07-13.md) | Exercise existing OpenCode homes, missing/unwritable paths, interrupted first launch, and database-name collision. Revert the identity checkpoint on failure. |
