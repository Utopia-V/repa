...
`44918ea10c0f99151c6710411b4322c2f5c96bea` is a pinned, read-only secondary
reference. Its pin is recorded in the [fork ledger](../fork-ledger.md); a local
checkout, when materialized beside the oracle, is ignored and never a runtime
dependency.
