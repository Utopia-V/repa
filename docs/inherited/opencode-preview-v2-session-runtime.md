# Inherited OpenCode preview-v2 Session runtime

Status: Retained inherited design evidence. This document is not Repa product,
runtime-baseline, roadmap, Gate-contract, or implementation authority. Its
queue/steer, client, Session, and context descriptions apply only when
inspecting the corresponding hibernated preview-v2 source. Current authority is
indexed by [the Repa documentation map](../README.md); the released-v1
production baseline is fixed by
